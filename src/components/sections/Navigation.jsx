  ...
  return (
    <nav className="text-primary-50 mx-auto flex h-16 w-full max-w-[90rem] items-center justify-between px-4 text-lg/8 font-light">
      ...
      <div className="flex items-center gap-x-3">
        ...
        <button
          className="bg-primary-500 text- text-primary-1300 border-primary-500 transition-properties hover:bg-primary-50 hover:border-primary-50 box-border cursor-pointer border-2 px-8 py-4 rounded-full text-lg/8 font-normal primary-glow hover:primary-glow-hover"
