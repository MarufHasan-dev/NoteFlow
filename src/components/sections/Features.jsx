...
export default function Features() {
  return (
    <section className="bg-primary-1500 overflow-hidden bg-[url(../src/assets/Noise.webp)] bg-repeat">
      <div className="relative text-primary-50 mx-auto max-w-[90rem] px-25 py-32 max-xl:px-16 max-xl:py-24">
        ...
        <h2 className="relative text-6xl/tight font-semibold  tracking-tighter text-center mb-28 max-xl:text-5xl/tight max-xl:mb-18">
          All The Tools You Need to{" "}
          <span className="text-primary-500 primary-glow">Supercharge</span>{" "}
          Your Note Taking
        </h2>

        <div className="relative grid grid-cols-2 items-center mb-20 gap-x-16 max-xl:mb-12">
          <figure>
            <img
          ...
          <div className="max-w-lg justify-self-end">
            <h3 className="text-5xl/14 tracking-tighter font-semibold mb-8 max-xl:mb-6 max-xl:text-4xl/10">
              Smart Organization
            </h3>
            <p className="text-xl/loose font-light text-primary-100 max-xl:text-lg/8">
