...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-bottom">
      <div className="flex justify-between place-items-start px-25 py-32 max-w-[90rem] mx-auto max-xl:px-16 max-xl:py-24 max-lg:grid max-lg:gap-x-8 max-lg:gap-y-18 max-lg:px-8 max-md:px-6 max-md:w-full">
        ...
        <div className="grid grid-cols-[repeat(4,max-content)] max-w-[680px] w-full justify-between max-lg:gap-x-24 max-md:gap-x-16 gap-y-16">
          {footerCols.map((col) => (
            <div key={col.id}>
