...
export default function MobileMenu() {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <button className="w-9.5 h-9.5 border-2 border-primary-75 items-center justify-center flex rounded-xl p-1.5 cursor-pointer hover:bg-primary-75 transition-properties group mb-16">
            <Close
              width={2}
        ...
        <div>
          ...
          <button className="text-primary-1300 text-base/loose p-3.5 bg-primary-500 border-2 border-primary-500 hover:bg-primary-50 hover:border-primary-50 w-full rounded-full primary-glow-hover transition-properties cursor-pointer box-border">
            Get Started
          </button>
        </div>
      </motion.div>
